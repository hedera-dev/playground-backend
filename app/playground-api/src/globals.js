...
const fs = require('fs');
const platform = process.env['PLATFORM'] ? process.env['PLATFORM'] : `${is_docker() ? 'docker' : 'baremetal'}-${fs
...
module.exports = {
    ...
    platform,
    pkg_installed_file: '.installation-state', //Used as indication for if a package was installed
