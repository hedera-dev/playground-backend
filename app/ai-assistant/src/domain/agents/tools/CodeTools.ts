...
export const proposeCodeTool = (applyCodeAgent: ICodeIntegrationAgent, code: string) => tool({
  ...
  execute: async (args: any) => {
    ...
    try {
      const appliedChanges = await applyCodeAgent.generateCodeChanges(args, code);
